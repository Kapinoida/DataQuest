...
is_in_dictionary_2 = 984 in content_ratings
...
ratings = []
rating_frequency = {'0 - 10000': 0, '10000 - 100000': 0, '100000 - 500000': 0, '500000 - 1000000': 0, '1000000+': 0}

for row in apps_data[1:]:
    rating = int(row[5])
    ratings.append(rating)
    if rating <= 10000:
        rating_frequency['0 - 10000'] += 1
    elif 10000 < rating <= 100000:
        rating_frequency['10000 - 100000'] += 1
    elif 100000 < rating <= 500000:
        rating_frequency['100000 - 500000'] += 1
    elif 500000 < rating <= 1000000:
        rating_frequency['500000 - 1000000'] += 1
    elif 1000000 < rating:
        rating_frequency['1000000+'] += 1
    
max_rating = max(ratings)
min_rating = min(ratings)

print('Max: ' + str(max_rating) + ' - Min: ' + str(min_rating))
