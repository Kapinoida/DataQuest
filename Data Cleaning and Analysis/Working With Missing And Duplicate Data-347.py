...
happiness2017.columns = happiness2017.columns.str.replace('.', ' ').str.replace('\s+', ' ').str.replace("[()]", '').str.strip().str.upper()
happiness2016.columns = happiness2016.columns.str.replace('.', ' ').str.replace('\s+', ' ').str.replace("[()]", '').str.strip().str.upper()
happiness2015.columns = happiness2015.columns.str.replace('.', ' ').str.replace('\s+', ' ').str.replace("[()]", '').str.strip().str.upper()
